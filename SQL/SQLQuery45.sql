	...
	BEGIN
		...
		IF (@Count = 0)
			BEGIN
				...
				SELECT Customer.ID, Customer.Name,Customer.Email, Customer.Customer_TypeId,Customer_Address.Id,Customer_Address.CustomerId,Customer_Address.Address,Customer_Address.Address_TypeId
				FROM Customer
...
EXEC  InsertCustomerWithAddressNew 'Rockey Hassan','rockey01@gmail.com','2','Pune', '1';


EXEC InsertCustomerWithAddressNew 'Ehtashamul Haque', 'ehtashamulhaque10@gmail.com', '4', 'Kolkata', '2';